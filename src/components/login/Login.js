...
//             />
//             <button
//               className="bg-blue-900 font-bold py-2 px-4 hover:bg-indigo-700 text-gray-100 w-full rounded-lg mt-4"
...
//               Cancel
//             </button>
//             {resetMessage && <p className="mt-2 text-sm text-green-500">{resetMessage}</p>}
//           </div>
//         </div>
//       )}
//     </div>
