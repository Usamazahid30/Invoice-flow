...
//               type="password"
//               id="currentPassword"
//               className="w-full border border-gray-300 rounded-md py-2 px-4 mt-1"
...
const Setting = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-center text-3xl font-bold mb-6 text-blue-600">Account Settings</h1>
        <p className="text-center text-lg text-gray-600 mb-4">Email: {email}</p>
        {error && <p className="text-red-500 text-center mb-4">{error}</p>}
        {success && <p className="text-green-500 text-center mb-4">{success}</p>}
        <form onSubmit={handlePasswordChange}>
          <div className="mb-4">
